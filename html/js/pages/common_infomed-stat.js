...
var common_infomed_stat = (function () {
	...
	dictionary.ca_level_post_chemo = "уровень СА после нео-химии";
	dictionary.ca_level_reduction_post_chemo = "снижение уровеня СА после нео-химии (%)";
	...
	dictionary.left_hepatic_art = "левая печеночная артерия";
	dictionary.right_hepatic_art = "правая печеночная артерия";
	...
	dictionary.blood_loss = "кровопотеря";
	dictionary.recovery_days = "послеоперационный койкодень";
	dictionary.duration = "длительность (мин)";
	dictionary.blood_transfusion = "трансфузии компонентов крови";
	dictionary.assistant = "оператор";
